...
<head>
	...
	<link rel="stylesheet" type="text/css" href="1.CSS_c/Inicio_c.css">
...
<!--Logo de la empresa con vinvulo al inicio-->
	...
	<!--Botones de Iniciar Sesion || Registrarse-->
				...
				<div class="registro" >
					<a href="../includes/logout.php"class="Registro"> <strong>Cerrar Sesion</strong></a>
				</div>

				<!--Cuaro de busqueda de la empresa-->
				<div class="box">
  					<div class="container-1">
     					 <input type="text" id="search" placeholder="Algún comentario?!"/>
 					 </div>
				</div>	
		</div>	
	</div>
