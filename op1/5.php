...
<div class="header">
    <div class="title">
        <h1>Tus sentimientos</h1>
    </div>

    <div class="contenedor-boton">
        <a href="4.php?id_c=<?php
                        if(isset($_SESSION['user'])){
                        $user->setUser($userSession->getCurrentUser());
                        echo ' '.$user->getid_c();}?>">
    ...
    <div class="imagen">
        <img src="fotos/img5.png" alt="Buscar en carpeta fotos de 'op1'" class="img_sonrrisa" >
    </div>

    <div class="text_1">
        <p class="p">
        En la vida llegamos a sentir muchísimas 
        cosas de toda índole y de nosotros depende 
        como tomar cada acción y tu enseñaste que 
        por mas derrotado que uno este es mejor salir 
        adelante, y que cuando el cariño es real no 
        importa que llegue a pasar siempre uno estará allí.
        </p>
    </div>
    ...
    <div class="div_mayor">
        ...
        <a href="../6.inicio_sesion_cliente/adentro2.php?id_c=<?php
                    ...
                    ?>">
                <li class="li"><strong>Inicio</strong></li>
            </div></a>
    </div>
</body>
</html>